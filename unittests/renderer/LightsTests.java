...
public class LightsTests {
   /**
    * First scene for some of test
    */
   private final Scene scene1 = new Scene("Test scene");
   /**
    * Second scene for some of test
    */
   private final Scene scene2 = new Scene("Test scene")
           .setAmbientLight(new AmbientLight(new Color(WHITE), new Double3(0.15)));

   /**
    * First camera builder for some of test
    */
   ...
   /**
    * Second camera builder for some of test
    */
...
//           .setLocation(new Point(0, 0, 1000))
//           .setDirection(new Vector(0,0,-1), new Vector(0, 1, 0))
//           .setVpSize(150.0, 150.0).setVpDistance(1000.0);
//   /** Second camera builder for some of test */
//   private final Camera.Builder camera2                 = Camera.getBuilder()
//           .setRayTracer(new SimpleRayTracer(scene2))
//           .setLocation(new Point(0, 0, 1000))
//           .setDirection(new Vector(0,0,-1), new Vector(0, 1, 0))
//           .setVpSize(200.0, 200.0).setVpDistance(1000.0);
//
//   /** Shininess value for most of the geometries in the tests */
//   private static final int     SHININESS               = 301;
//   /** Diffusion attenuation factor for some of the geometries in the tests */
...
//
//   /** Material for some of the geometries in the tests */
//   private final Material material = new Material().setKd(KD3).setKs(KS3).setNShininess(SHININESS);   /** Light color for tests with triangles */
//   private final Color          trianglesLightColor     = new Color(800, 500, 250);
//   /** Light color for tests with sphere */
//   private final Color          sphereLightColor        = new Color(800, 500, 0);
//   /** Color of the sphere */
...
//      scene1.lights.add(new DirectionalLight(new Color(400, 200, 0), new Vector(-1, -1, -1)));
//      scene1.lights.add(new PointLight(new Color(200, 400, 200), new Point(50, 50, 50))
//              .setKl(0.001).setKq(0.0002));
//      scene1.lights.add(new SpotLight(new Color(200, 200, 400), new Point(-50, -50, 25), new Vector(1, 1, -0.5))
//              .setKl(0.001).setKq(0.0001));
//
